...
export type DailyScore = {
  ...
  // Per-muscle stimulus generated by today's workout:
  // Σ ln(loadRatio × reps × eMod + 1) per group. Zero when no workout logged.
  today_muscle_stimulus: Record<string, number>;
